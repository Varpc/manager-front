...
import { adminAsideMenuConfig } from './../../menuConfig';
import './scss/light.scss';

const asideMenuConfig = adminAsideMenuConfig;
...
const styles = {
  ...
  mainContent: {
    padding: '0',
    minHeight: 'calc(100vh - 58px - 76px)', // 使页脚动态的固定在底部，窗口高度减去header和footer的高度
  },
};
